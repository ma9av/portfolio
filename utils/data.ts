  ...
  experiences: [
    {
      ...
      desc: "Completed my 6 week internship in IBM SkillsBuild in Front end Web Development, where" +
            "I built a React web app named ‘Know Your Air’, which displays the Air Quality Index (AQI)" +
